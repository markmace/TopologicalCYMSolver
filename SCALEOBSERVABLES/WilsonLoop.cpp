#ifndef __WILSON_LOOP__CPP__
#define __WILSON_LOOP__CPP__
...
namespace Observables {
    ...
    namespace WilsonLoop{
        ...
        // COMPUTES Tr(1-WILSON LOOP) OF A GIVEN SIZE AT A GIVEN POINT
        void CalculateTrIdMinusWilsonLoop(INT L,INT NSamples,GaugeLinks *U,DOUBLE &UxyAvg,DOUBLE &UyzAvg,DOUBLE &UzxAvg){
        ...
        void WilsonLoopHistogram(std::string fname,GaugeLinks *U){
            ...
            for (INT L=1;L<(BlockedU->N[0])/2;L++){
                ...
                CalculateTrIdMinusWilsonLoop(L,40000,BlockedU,UxyAvg,UyzAvg,UzxAvg);
